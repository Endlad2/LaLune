...
#
# LaLune OpenWRT — установщик / обновлятор для OpenWRT с opkg (<= 24.x).
#
...
#
# Запуск:
#   wget -qO- https://raw.githubusercontent.com/Endlad2/LaLune/main/OpenWRT/lalune-owrt-install-opkg.sh | sh
...
if ! command -v opkg >/dev/null 2>&1; then
    die "opkg не найден. Похоже, у вас новая OpenWRT с apk — используйте lalune-owrt-install-apk.sh"
fi
...
============================================================
  LaLune OpenWRT установлен (opkg).
============================================================
